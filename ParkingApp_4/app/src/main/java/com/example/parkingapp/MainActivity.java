...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //change
        String apiKey = "AIzaSyCL6_2CegP8QXrjdLipxUiiqINMzySFhAc";
        String modelName = "gemini-1.5-flash";
        String filePath = "D://Semester 10 (Fall 2024)//Software Engineering//Project//ParkingApp//parking_data//A1.csv";

        ParkingAI parkingAI = new ParkingAI(apiKey, modelName, filePath);
        String nextAvailableTime = parkingAI.getNextAvailableTime();

        if (nextAvailableTime != null) {
            System.out.println("The next available time for the spot is: " + nextAvailableTime);
            Log.d("MainActivity", "The next available time for the spot is: " + nextAvailableTime);
        } else {
            System.out.println("Could not determine the next available time.");
            Log.d("MainActivity", "Could not determine the next available time.");
        }
